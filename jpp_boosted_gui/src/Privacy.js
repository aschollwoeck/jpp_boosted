...
function Privacy(props) {
    return (
        <div>
            ...
            Schutz der Daten vor dem Zugriff durch Dritte ist nicht m&ouml;glich.</p><p>&nbsp;</p> <h2>Server-LogFiles</h2>
            ...
            gespeichert. Diese Daten geben wir nicht ohne Ihre Einwilligung weiter.</p><p>&nbsp;</p> <h2>Google
            ...
            https://support.google.com/analytics/answer/6004245?hl=de</a></p><p>&nbsp;</p> <h2>YouTube</h2>
            ...
            hergestellt. Dabei wird dem Youtube-Server mitgeteilt, welche unserer Seiten Sie besucht haben.</p> <p>
            Wenn Sie in Ihrem YouTube-Account eingeloggt sind erm&ouml;glichen Sie YouTube, Ihr Surfverhalten
            direkt Ihrem pers&ouml;nlichen Profil zuzuordnen. Dies k&ouml;nnen Sie verhindern, indem Sie sich aus
            Ihrem YouTube-Account ausloggen.</p> <p>Weitere Informationen zum Umgang von Nutzerdaten finden
            Sie in der Datenschutzerkl&auml;rung von YouTube unter: <a
            ...
            Dritten mitgelesen werden.</p><p>&nbsp;</p> <h2>Recht auf Auskunft, L&ouml;schung, Sperrung</h2>
            ...
            angegebenen Adresse an uns wenden.</p><p>&nbsp;</p> <p>Quelle: <a href="https://www.erecht24.de">eRecht24</a></p>
        </div>
    );
}
